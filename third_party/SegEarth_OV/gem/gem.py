...
from open_clip_custom.constants import OPENAI_DATASET_MEAN, OPENAI_DATASET_STD
...
def get_tokenizer(
    ...
    return open_clip_custom.get_tokenizer(model_name=model_name, context_length=context_length, **kwargs)
...
def create_gem_model(
    ...
    open_clip_model = open_clip_custom.create_model(model_name, pretrained, precision, device, jit, force_quick_gelu, force_custom_text,
    ...
    tokenizer = open_clip_custom.get_tokenizer(model_name=model_name)
