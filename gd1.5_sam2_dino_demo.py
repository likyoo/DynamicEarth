...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--gd_api_token", type=str,
                        default="",
                        help="API TOKEN for Grounding DINO. " \
                            "Get it from https://cloud.deepdataspace.com",)
...
def initialize_models(args):
    ...
    return sam2_predictor, comparator_model, comparator_processor

def process_image_pair(args, sam2_predictor, comparator_model, comparator_processor, img_pair_paths):
    ...
    img1_boxes, img1_class_ids = extract_bbox_and_cls_from_dino1_5(args.gd_api_token, 
                                                                   img1_path, text_prompt=args.text_prompt)
    img2_boxes, img2_class_ids = extract_bbox_and_cls_from_dino1_5(args.gd_api_token, 
                                                                   img2_path, text_prompt=args.text_prompt)
...
def main(args):
    ...
    # Initialize models
    sam2_predictor, comparator_model, comparator_processor = initialize_models(args)
    
    # Process each image pair
    change_mask = process_image_pair(
        args, sam2_predictor, comparator_model, comparator_processor, 
