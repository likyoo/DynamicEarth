...
BACKGROUND_CLASS = ['background', 'cropland', 'ground', 'tree', 'forest',
                    'bareland', 'barren', 'pavement', 'road', 'parking lot', 'soil',
                    'building', 'sports field', 'non-vegetated ground surface']
FOREGROUND_CLASS = ['water', 'river', 'pond', 'sea']
TEXT_PROMPT = [','.join(BACKGROUND_CLASS), ','.join(FOREGROUND_CLASS)]
INPUT_DIR = 'data/SECOND2/val'
OUTPUT_DIR = 'output/SECOND_exp/test_sam2_dinov2_segearth-ov_water'
