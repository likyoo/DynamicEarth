...
BACKGROUND_CLASS = ['background', 'ground', 'bareland', 'water', 'cropland',
                    'building', 'sports field', 'grass']
FOREGROUND_CLASS = ['tree', 'forest']
TEXT_PROMPT = [','.join(BACKGROUND_CLASS), ','.join(FOREGROUND_CLASS)]
INPUT_DIR = 'data/SECOND2/val'
OUTPUT_DIR = 'output/SECOND_exp/test_sam2_dinov2_segearth-ov_tree_145'
